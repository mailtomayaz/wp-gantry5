...
class __TwigTemplate_267175d89419c210550a6e1d9ac52a4ccecfa263e8561ae7ffc697151cab11cb extends Twig_Template
{
    ...
    protected function doDisplay(array $context, array $blocks = array())
    {
        ...
        try {            // line 2
            ...
            echo $this->getAttribute(($context["e"] ?? null), "getMessage", array());
            echo "</div>
";
        }
        // line 6
...
($context["mode"] ?? null) == "submenu")) {
                    echo " style=\"width:";
                    echo $this->getAttribute(($context["item"] ?? null), "width", array());
    ...
    public function getdisplayParticle($__item__ = null, $__context__ = null, ...$__varargs__)
    {
        ...
        try {
            ...
            echo ((($context["classes"] ?? null)) ? ((" " . ($context["classes"] ?? null))) : (""));
            echo "\">
    ";
            // line 19
            try {
...
";
    ...
    public function getdisplayTitle($__item__ = null, ...$__varargs__)
    {
        ...
        try {
            ...
            if (( !$this->getAttribute(($context["item"] ?? null), "icon_only", array()) ||  !($this->getAttribute(($context["item"] ?? null), "image", array()) || $this->getAttribute(($context["item"] ?? null), "icon", array())))) {
                ...
                echo $this->getAttribute(($context["item"] ?? null), "title", array());
                echo "</span>
        ";
                // line 27
                if ($this->getAttribute(($context["item"] ?? null), "subtitle", array())) {
                    ...
                    echo $this->getAttribute(($context["item"] ?? null), "subtitle", array());
                    echo "</span>
        ";
                }
                // line 30
    ...
    public function getdisplayItem($__item__ = null, $__menu__ = null, $__context__ = null, $__dropdown_type__ = null, ...$__varargs__)
    {
        ...
        <li class=\"g-menu-item g-menu-item-type-";
                // line 47
                echo $this->getAttribute(($context["item"] ?? null), "type", array());
                echo " g-menu-item-";
                echo $this->getAttribute(($context["item"] ?? null), "id", array());
                ...
                echo " ";
                echo (($this->getAttribute(($context["item"] ?? null), "class", array(), "any", true, true)) ? (_twig_default_filter($this->getAttribute(($context["item"] ?? null), "class", array()), "")) : (""));
                echo "\"";
                // line 48
            ...
            ";
                ...
                if ($this->getAttribute(($context["item"] ?? null), "url", array())) {
                    ...
                    echo (($this->getAttribute(($context["item"] ?? null), "anchor_class", array())) ? ((" " . $this->getAttribute(($context["item"] ?? null), "anchor_class", array()))) : (""));
                    echo "\" href=\"";
                    echo $this->getAttribute(($context["item"] ?? null), "url", array());
                    echo $this->getAttribute(($context["item"] ?? null), "hash", array());
                    echo "\"";
            ...
            ";
                ...
                if ($this->getAttribute(($context["item"] ?? null), "image", array())) {
                    // line 53
                    echo "                    <img src=\"";
                    echo $this->env->getExtension('Gantry\Component\Twig\TwigExtension')->urlFunc($this->getAttribute(($context["item"] ?? null), "image", array()));
                    echo "\" alt=\"";
                    echo $this->getAttribute(($context["item"] ?? null), "title", array());
                    echo "\" />
                ";
...
($context["item"] ?? null), "icon", array())) {
                    // line 55
                    echo "                    <i class=\"";
                    echo $this->getAttribute(($context["item"] ?? null), "icon", array());
    ...
    public function getdisplayContainers($__item__ = null, $__menu__ = null, $__context__ = null, $__dropdown_type__ = null, ...$__varargs__)
    {
        ...
        ";
            ...
            foreach ($context['_seq'] as $context["column"] => $context["items"]) {
                ...
                echo call_user_func_array($this->env->getFilter('toGrid')->getCallable(), array($this->getAttribute(($context["item"] ?? null), "columnWidth", array(0 => $context["column"]), "method")));
                echo "\">
            <ul class=\"g-sublevel\">
                <li class=\"g-level-";
                // line 92
                echo $this->getAttribute(($context["item"] ?? null), "level", array());
                echo " g-go-back\">
...
";
    ...
    public function getdisplaySubmenu($__item__ = null, $__menu__ = null, $__context__ = null, $__dropdown_type__ = null, ...$__varargs__)
    {
        ...
        try {
            ...
            if ( !$this->getAttribute(($context["item"] ?? null), "dropdown_hide", array())) {
                ...
                echo ($context["animation"] ?? null);
                echo " ";
                echo ($context["dropdown_dir"] ?? null);
                echo "\"";
    ...
    {
        return new Twig_Source("", "@particles/menu.html.twig", "/var/www/html/wp/wp-content/plugins/gantry5/engines/nucleus/particles/menu.html.twig");
    }
}
