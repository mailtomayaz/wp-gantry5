...
class __TwigTemplate_319d2f263967bdf8a39c70ff0276733564458f58eca592debf63481d3166981a extends Twig_Template
{
...
";
    ...
    {
        return new Twig_Source("{% set updates = gantry.platform.updates %}
{% if updates %}
        ...
        <div class=\"update-header clearfix\">
            ...
            <div class=\"update-tools\">
                <a href=\"{{ gantry.platform.update|raw }}\" class=\"button button-update\">
                    <i class=\"fa fa-refresh\" aria-hidden=\"true\"></i> <span>{{ 'GANTRY5_PLATFORM_UPDATE'|trans }}</span>
                </a>
                <a href=\"#\" data-changelog=\"{{ version }}\" class=\"button button-update\">
                    <i class=\"fa fa-book\" aria-hidden=\"true\"></i> <span>{{ 'GANTRY5_PLATFORM_CHANGELOG'|trans }}</span>
                </a>
                <a href=\"#\" class=\"fa fa-close\" aria-hidden=\"true\" data-g-close=\".g-grid\"></a>
            </div>
        </div>
...
{% endif %}
", "@gantry-admin/partials/updates.html.twig", "/var/www/html/wp/wp-content/plugins/gantry5/admin/templates/partials/updates.html.twig");
    }
}
