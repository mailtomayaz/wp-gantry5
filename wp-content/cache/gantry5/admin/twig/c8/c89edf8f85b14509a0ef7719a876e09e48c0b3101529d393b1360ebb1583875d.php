...
class __TwigTemplate_7c6c4d8089dd4f2156e28fcdd16d4ddefd3b70eca13efbd5d64eb43ba8f4b7d4 extends Twig_Template
{
    ...
    <div class=\"g-block navbar-block\">
        ...
        echo "</span>
                    ...
                    ";
        // line 49
        if (((($context["configuration"] ?? null) && (($context["configuration"] ?? null) != "default")) &&  !(is_string($__internal_a1db1b174ac5d81abcb018ddf10c7d4580b829b84a2efaba3d935df7376b411a = ($context["configuration"] ?? null)) && is_string($__internal_0c146a028732372f9ed5a7e0409a4d2b4c6700aa696af4cae7e0146f3d3fe507 = "_") && ('' === $__internal_0c146a028732372f9ed5a7e0409a4d2b4c6700aa696af4cae7e0146f3d3fe507 || 0 === strpos($__internal_a1db1b174ac5d81abcb018ddf10c7d4580b829b84a2efaba3d935df7376b411a, $__internal_0c146a028732372f9ed5a7e0409a4d2b4c6700aa696af4cae7e0146f3d3fe507))))) {
            // line 50
            echo "                    <li ";
...
";
    ...
    {
        return new Twig_Source("<div class=\"g-grid\">
    <div class=\"g-block navbar-block\">
        <nav id=\"gantry\">
            ...
            <section id=\"navbar\"{{ style|raw }}>
                <ul>
                    ...
                    <li {{ (location == 'configurations/styles') ? 'class=\"active\"' }}>
                        ...
                        >
                            <i class=\"fa fa-fw fa-adjust\" aria-hidden=\"true\"></i><span>{{ 'GANTRY5_PLATFORM_STYLES'|trans }}</span>
                        </a>
                    </li>
                    <li {{ (location == 'configurations/layout') ? 'class=\"active\"' }}>
                        ...
                        >
                            <i class=\"fa fa-fw fa-columns\" aria-hidden=\"true\"></i><span>{{ 'GANTRY5_PLATFORM_LAYOUT'|trans }}</span>
                        </a>
                    </li>
                    <li {{ (location == 'configurations/content') ? 'class=\"active\"' }}>
                        ...
                        >
                            <i class=\"fa fa-fw fa-file-text-o\" aria-hidden=\"true\"></i><span>{{ 'GANTRY5_PLATFORM_CONTENT'|trans }}</span>
                        </a>
                    </li>
                    ...
                    <li {{ (location == 'configurations/assignments') ? 'class=\"active\"' }}>
                        ...
                        >
                            <i class=\"fa fa-fw fa-check-square-o\" aria-hidden=\"true\"></i><span>{{ 'GANTRY5_PLATFORM_ASSIGNMENTS'|trans }}</span>
                        </a>
                    </li>
                    {% endif %}
                    {% if (location == 'configurations/settings' or gantry.particles.overrides(configuration)) %}
                        <li {{ (location == 'configurations/settings') ? 'class=\"active\"' }}>
                            ...
                            >
                                <i class=\"fa fa-fw fa-wrench\" aria-hidden=\"true\"></i><span>{{ 'GANTRY5_PLATFORM_PARTICLE_DEFAULTS'|trans }}</span>
                            </a>
                        </li>
                    {% endif %}
                </ul>
...
", "@gantry-admin/partials/navigation.html.twig", "/var/www/html/wp/wp-content/plugins/gantry5/admin/templates/partials/navigation.html.twig");
    }
}
