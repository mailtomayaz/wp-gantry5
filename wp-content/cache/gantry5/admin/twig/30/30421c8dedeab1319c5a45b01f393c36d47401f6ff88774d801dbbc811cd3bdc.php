...
class __TwigTemplate_cf00e185a9363470cbd61428cf24f190c2cb223c4cbffcf3680613ef4961b078 extends Twig_Template
{
...
<div id=\"outline-{{ name }}\" class=\"page\">
    <h4>
        ...
        {% else %}
            ...
            <i class=\"fa fa-fw fa-pencil font-small\" aria-hidden=\"true\" tabindex=\"0\" aria-label=\"{{ 'GANTRY5_PLATFORM_EDIT_TITLE'|trans(title|e) }}\" data-title-edit=\"\"></i>
            {% else %}
                {{ title }}
            {% endif %}
        {% endif %}
...
", "@gantry-admin/layouts/outline.html.twig", "/var/www/html/wp/wp-content/plugins/gantry5/admin/templates/layouts/outline.html.twig");
    }
}
