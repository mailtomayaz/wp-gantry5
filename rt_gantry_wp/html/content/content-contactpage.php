...
?>
			...
			<div <?php post_class('contact-form-page'); ?> id="post-<?php the_ID(); ?>">
				...
				<?php if( isset( $emailSent ) && $emailSent == true ) : ?>
					...
					<p class="success">
						<?php _e( 'Your email was sent successfully. Thank you!', 'rt_gantry_wp_lang' ); ?>
					</p>

					<p class="back-to-home">
						<a href="<?php echo home_url(); ?>" class="btn btn-primary btn-small"><span class="icon-arrow-left"></span> <?php _e( 'Back to the homepage', 'rt_gantry_wp_lang' ); ?></a>
					</p>
				...
				<?php else : ?>
					...
					<?php if( isset($hasError) || !$validated ) : ?>
						...
						<p class="error">
							<?php _e( 'Sorry, an error occured. Please try again.', 'rt_gantry_wp_lang' ); ?>
						</p>
					...
					<form action="<?php the_permalink(); ?>" id="rt-contact-form" method="post">
						...
						<div class="control-group<?php if($name_error != '') echo ' error'; ?>">
							<label for="rt-contact-name"><?php _e( 'Name', 'rt_gantry_wp_lang' ); ?></label>
							<div class="controls">
						...
						<div class="control-group<?php if($email_error != '') echo ' error'; ?>">
							<label for="rt-contact-email"><?php _e( 'Email', 'rt_gantry_wp_lang' ); ?></label>
							<div class="controls">
						...
						<div class="control-group<?php if($message_error != '') echo ' error'; ?>">
							<label for="rt-contact-message"><?php _e( 'Message', 'rt_gantry_wp_lang' ); ?></label>
							<div class="controls">
						...
						<div class="control-group">
							<div class="controls">
								<label class="checkbox send-copy">
									<input type="checkbox" name="rt-send-copy" id="rt-send-copy" value="true" /> <?php _e( 'Send me a copy of this email.', 'rt_gantry_wp_lang' ); ?>
								</label>
								<button class="btn btn-primary" type="submit" name="submit" id="submit"><?php _e( 'Send Message', 'rt_gantry_wp_lang' ); ?></button>
