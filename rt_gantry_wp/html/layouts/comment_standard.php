	...
	static function render_comment( $comment, $args, $depth ) {
		...
		<li <?php comment_class(); ?> id="li-comment-<?php comment_ID(); ?>">
			<div id="comment-<?php comment_ID(); ?>" class="comment-body comment">
				...
				<p class="info">
					<span class="awaiting-moderation"><?php _e( 'Your comment is awaiting moderation.', 'rt_gantry_wp_lang' ); ?></span>
				</p>
				<?php endif; ?>
				...
				<div class="comment-content">
						...
						<small>
							<?php 
								...
								echo sprintf(
									...
									sprintf( __( '%1$s at %2$s', 'rt_gantry_wp_lang' ),
									get_comment_date(),
									get_comment_time() )
								);
							?>
					...
					<?php edit_comment_link( __( 'Edit', 'rt_gantry_wp_lang' ), '<p class="edit-link">', '</p>' ); ?>
				</div>

				<div class="reply">
					<?php comment_reply_link( array_merge( $args, array( 'reply_text' => __( 'Reply', 'rt_gantry_wp_lang' ), 'depth' => $depth, 'max_depth' => $args['max_depth'] ) ) ); ?>
				</div>
